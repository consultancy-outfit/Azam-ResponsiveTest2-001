...
const ImageMap = () => {
  ...
  const calculateStyle = (area: any) => {
    ...
    return {
      position: "absolute",
      left: `${(area.x / 1867) * 100}%`,
      top: `${(area.y / 9451) * 100}%`,
      width: `${(area.width / 1867) * 100}%`,
      height: `${(area.height / 9451) * 100}%`,
