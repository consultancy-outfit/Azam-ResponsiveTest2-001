    ...
    <Box m={2}>
      ...
      >
        <Button
          ...
          variant="contained"
          color="primary"
          onClick={() => window.open("https://scrypt.swiss/", "_blank")}
        >
          Application/JSON
        </Button>
        ...
        <Button
          ...
          onClick={() =>
            window.open(
              "https://uploads-ssl.webflow.com/65b7df67f3cf496d06acb907/65d77e3e7a09868617766110_Scrypt%20FIX%20API.pdf",
              "_blank"
            )
          }
        >
        ...
        <Button
          ...
          onClick={() =>
            window.open(
              "https://doc.client.scrypt.swiss/dba71e6d-f5d6-4d7f-a9ca-84d5f8a318f7",
              "_blank"
            )
          }
        >
